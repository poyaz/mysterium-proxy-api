import {MystCreateDockerRepository} from './myst-create-docker.repository';
...
describe('MystCreateDockerRepository', () => {
  let repository: MystCreateDockerRepository;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: MystCreateDockerRepository,
          ...
          useFactory: (docker: Docker, identity: IIdentifier) =>
            new MystCreateDockerRepository(docker, identity, {
              imageName,
              networkName,
    ...
    repository = module.get<MystCreateDockerRepository>(MystCreateDockerRepository);
